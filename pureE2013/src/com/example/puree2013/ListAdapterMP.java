...
public class ListAdapterMP extends BaseAdapter {
	static Button playButton_mp;
	static IconTextItem mp_staticIti;
	static PlayButton mp_pButton;
    ...
    public ListAdapterMP(Context context) { 
        mContext = context;        
        ...
        if (cv == null) { 
        	...
        	holder.play_btn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					mp_staticIti = mItems.get(getPosition);
				}
				}
			});
